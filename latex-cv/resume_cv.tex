...
\name{Andrea}{Petreti}
\mobile{(+39) 334-87-82-198}

\email{petretiandrea@gmail.com}
\homepage{petretiandrea.github.io}
\github{petretiandrea}
\linkedin{andrea-petreti}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Backend Engineer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{}{Andrea Petreti~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
