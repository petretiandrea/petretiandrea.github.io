const e={welcome:{t:0,b:{t:2,i:[{t:3}],s:"Ciao!"}},about_me:{t:0,b:{t:2,i:[{t:3}],s:`Sono Andrea Petreti, Software Engineer presso PagoPA S.p.A.
...
`}},project_page_title:{t:0,b:{t:2,i:[{t:3}],s:"Progetti"}},project_page_description:{t:0,b:{t:2,i:[{t:3}],s:"Alcuni dei miei progetti o al quale ho collaborato"}},menu_home:{t:0,b:{t:2,i:[{t:3}],s:"Home"}},menu_projects:{t:0,b:{t:2,i:[{t:3}],s:"Progetti"}},menu_blog:{t:0,b:{t:2,i:[{t:3}],s:"Blog"}},menu_cv:{t:0,b:{t:2,i:[{t:3}],s:"Curriculum"}}};export{e as default};
